...
export default function RulesModal({ onClose, playSound }: RulesModalProps) {
  return (
    <div className="fixed inset-0 bg-background/80 backdrop-blur-md z-50 flex items-center justify-center p-4 sm:p-6 animate-fade-in">
      <div className="bg-card text-card-foreground rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 max-w-md w-full max-h-[85vh] overflow-y-auto shadow-2xl border border-border">
